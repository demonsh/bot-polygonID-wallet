...
import { DEFAULT_ACCOUNT_NAME } from "../constants/index.js";
import { WalletService } from "../services/Wallet.service.js";

const $router = useRouter();

const isIdentityPresent = ref(false);
const input = ref({ password: '123123', confirmPassword: '123123' });
const error = ref({ password: '', confirmPassword: '' });
...
onMounted(async () => {
  ...
  try {
    ...
    isIdentityPresent.value = identities.length > 0;
  } catch (err) {
    console.log(err);
  }
});
...
<template>
  <div class="wrap-bg">
    ...
    <div class="wrap-main" style="max-width: 400px; height: 100vh;">
      <div class="column justify-around full-height">
        <div class="text">
          <h3>Protection <br> What matters <br> Most</h3>
          <p>
            Your account is protected by a password. <br>
            Please create a password to secure your account.
          </p>
        </div>
        <q-form
            @submit="handleClickCreatePassword"
        >
                  <q-input
                      filled
                      ...
                      label="Your pass *"
                      type="password"
                      style="position: fixed; z-index: 1; opacity: 0; visibility: hidden;"
          ...
          <div class="row q-col-gutter-md">
            <div class="col col-6">
              <q-btn label="Register" type="reset" color="primary" outline rounded size="lg" class="full-width" />
            </div>
            <div class="col col-6">
              <q-btn label="Open account" type="submit" rounded color="black" size="lg" class="full-width"/>
            </div>
          </div>
        </q-form>
      </div>
